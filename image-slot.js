...
(() => {
  ...
  // Read a file as a raw data URL, untouched. Used for GIFs, whose animation
  // a canvas re-encode would flatten to a single frame.
  ...
  async function toDataUrl(file, targetW) {
    // Animated formats pass through raw so frames survive.
    if (file.type === 'image/gif') return fileToRawDataUrl(file);
